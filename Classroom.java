...
public class Classroom {
    ...
    public void createSeats(String openSeatsFile) {
        ...
        openSeats = new boolean[rows][columns];
        studentsInSeats = new Student[rows][columns];
    ...
    public void seatStudents() {
        int rows = studentsInSeats.length;
        int columns = studentsInSeats[0].length;
    ...
    public void insertByName(Student eliminatedStudent) {
        ...
        if (studentsInLine == null || eliminatedStudent.compareNameTo(studentsInLine.getStudent()) < 0) 
        {
        ...
        while (curr != null && eliminatedStudent.compareNameTo(curr.getStudent()) > 0) 
        {
            prev = curr;
            curr = curr.getNext();
        }
    ...
    public void eliminateLosingStudents() {
        ...
        while (ptr != null && (ptr != musicalChairs || size == 0))
        {
            size++;
            ptr = ptr.getNext();
